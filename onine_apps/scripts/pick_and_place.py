...
if __name__=='__main__':
    ...
    g.pre_grasp_approach = onine_arm.make_gripper_translation(0.1, 0.15)
    g.post_grasp_retreat = onine_arm.make_gripper_translation(0.1, 0.15, -1.0)
    g.grasp_pose = grasp_pose
    g.allowed_touch_objects = ["part", "table"]
    ...
    for p in pitch_vals:
        q = quaternion_from_euler(0, 1.570796 - p, aim_yaw)
